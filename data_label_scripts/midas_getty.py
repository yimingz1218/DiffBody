...
def main():
    ...
    os.makedirs("/fsx_laion/alvin/Dataset/getty_human_midas", exist_ok=True)
    ...
    for tar_file in tqdm(all_tar_list):
        try:
            ...
            os.system(f"rm -f {os.path.join('/fsx_laion/alvin/Dataset/getty_human_midas', tar_name)}")
            writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/getty_human_midas", tar_name))
            ...
            os.system(f"rm -f {os.path.join('/fsx_laion/alvin/Dataset/getty_human_midas', tar_file.split('/')[-1])}")
