...
def main():
    ...
    # numbers = []
    # with open("/fsx_laion/alvin/sd4human/aes-laion-miss.txt", "r") as file:
    #     for line in file:
    #         numbers.append(int(line.strip()))
    # numbers = [60445, 64052, 64053, 64054, 64055, 64057, 64058, 64059, 64060, 64063, 64065, 64273, 64275, 64276, 64277, 64279, 64283, 64284, 64552, 64558, 65408, 65413, 65415, 65416, 65417, 65419, 65420, 65421, 65423, 65428, 65429, 65431, 65530, 65543, 65544]
    ...
    # for name in data_args.train_data:
        # sink_writers[name.split('/')[-1]] = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/laion_images_webdataset_human", name.split('/')[-1]))
    os.makedirs("/fsx_laion/alvin/Dataset/laion_human_aes", exist_ok=True)
    ...
    for tar_file in tqdm(all_tar_list):
        try:
            ...
            os.system(f"rm -f {os.path.join('/fsx_laion/alvin/Dataset/laion_human_aes', tar_name)}")
            writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/laion_human_aes", tar_name))
            ...
            os.system(f"rm -f {os.path.join('/fsx_laion/alvin/Dataset/laion_human_aes', tar_file.split('/')[-1])}")
