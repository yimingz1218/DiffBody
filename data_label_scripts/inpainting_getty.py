...
def main():
    ...
    os.makedirs('/fsx_laion/alvin/Dataset/getty_human_inpaint', exist_ok=True)
    cnt = 0
    ...
    for tar_file in all_tar_list:
        ...
        writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/getty_human_inpaint", tar_file.split('/')[-1]))
