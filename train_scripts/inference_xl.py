    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i_batch in range(batch_size):
            ...
            output = pipeline(
                ...
                "A mesmerizing oil painting in the style of Van Gogh, portraying a confident woman gracefully dancing ballet in a moonlit garden, wearing an elegant tutu and performing a series of intricate leaps and twirls, 64K resolution, a fusion of artistic mastery and captivating movement.",
