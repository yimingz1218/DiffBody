...
def parse_args():
    ...
    ################################### newly added args ###################################
    parser.add_argument("--t2mn_path", type=str, default="/fsx_laion/alvin/sd4human/a-ranstart-body-sdv20-v-nd-flaw-avg-copy1-glc-resume288k-512-ft1024/checkpoint-340000")
    parser.add_argument("--controlnet_model_name_or_path", type=str, default="/fsx_laion/alvin/sd4human/ctrl-sdxl10-eps-glc-composer-bmn-sum-1024-ft1024/checkpoint-75000")
    parser.add_argument('--step_num1', default=200, type=int)
    parser.add_argument('--step_num2', default=200, type=int)
    parser.add_argument('--size', default=1024, type=int)
    parser.add_argument("--pretrained_vae_model_name_or_path", type=str, default='/fsx_laion/alvin/pretrain/sdxl-vae-fp16-fix')
    ...
    parser.add_argument("--enable_xformers_memory_efficient_attention", default=True, action="store_false", help="Whether or not to use xformers.")
    ...
    parser.add_argument("--pretrained_model_name_or_path",type=str,default='/fsx_laion/alvin/pretrain/stable-diffusion-2-base')
    parser.add_argument("--pretrained_model_name_or_path2",type=str,default='/fsx_laion/alvin/pretrain/stable-diffusion-xl-base-1.0')
    parser.add_argument('--prediction_type', type=str, default='v_prediction', choices=['epsilon', 'v_prediction', 'target'], help='Select a mode')
    parser.add_argument('--prediction_type2', type=str, default='epsilon', choices=['epsilon', 'v_prediction', 'target'], help='Select a mode')
    ...
    parser.add_argument('--cond_type', type=str, default=["body", "midas_depth", "normal"], nargs="+", help='add which types of conditions')
