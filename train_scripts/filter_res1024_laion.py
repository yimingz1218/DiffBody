...
def main():
    ...
    os.makedirs('/fsx_laion/alvin/Dataset/laion_human_1024x1024', exist_ok=True)
    # cnt1 = 0
    # cnt2 = 0
    # cnt = 0
    ...
    for tar_file in tqdm(all_tar_list):
        ...
        writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/laion_human_1024x1024", tar_file.split('/')[-1]))
