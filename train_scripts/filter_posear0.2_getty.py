...
def main():
    ...
    os.makedirs('/fsx_laion/alvin/Dataset/getty_human_posear0.2', exist_ok=True)
    # cnt1 = 0
    # cnt2 = 0
    cnt = 0
    ...
    for tar_file in all_tar_list:
        ...
        writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/getty_human_posear0.2", tar_file.split('/')[-1]))
