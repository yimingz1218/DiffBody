...
def main():
    ...
    all_tar_list = ["/fsx_laion/alvin/Dataset/getty_human_aes/2e664f92-c2e8-42ce-9fc4-e0d34981372f.tar"]
    ...
    os.makedirs('/fsx_laion/alvin/Dataset/getty_human_1024x1024', exist_ok=True)
    # cnt1 = 0
    # cnt2 = 0
    cnt = 0
    ...
    for tar_file in tqdm(all_tar_list):
        try:
            os.system(f"sudo rm -f {os.path.join('/fsx_laion/alvin/Dataset/getty_human_1024x1024', tar_file.split('/')[-1])}")
            writer = wds.TarWriter(os.path.join("/fsx_laion/alvin/Dataset/getty_human_1024x1024", tar_file.split('/')[-1]))
